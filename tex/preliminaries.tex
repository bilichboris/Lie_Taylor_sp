...
The homology can be computed using Chevalley-Eilenberg \todo{ref weibel, guichardet} free resolution of the trivial $\lieg$
...
\begin{theorem}[Poincare duality]
    ...
    \[
        H^k(\lieg, V^*) \cong H^{n - k}(\lieg,  \bigwedge^n \lieg\otimes_\cmpl W)^*. 
    \]
\end{theorem}
\begin{proof}
